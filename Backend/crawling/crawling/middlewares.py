...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self):
        ...
        self.scrapeops_endpoint = os.getenv('SCRAPEOPS_FAKE_USER_AGENT_ENDPOINT')
        self.scrapeops_fake_user_agents_active = os.getenv('SCRAPEOPS_FAKE_USER_AGENT_ENABLED')
        self.scrapeops_num_results = os.getenv('SCRAPEOPS_NUM_RESULTS')
        self.headers_list = []
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self):
        self.scrapeops_api_key = os.getenv('SCRAPEOPS_API_KEY')
        self.scrapeops_endpoint = os.getenv('SCRAPEOPS_FAKE_BROWSER_HEADER_ENDPOINT')
        self.scrapeops_fake_browser_headers_active = os.getenv('SCRAPEOPS_FAKE_BROWSER_HEADER_ENABLED'), True
        self.scrapeops_num_results = os.getenv('SCRAPEOPS_NUM_RESULTS')
        self.headers_list = []
